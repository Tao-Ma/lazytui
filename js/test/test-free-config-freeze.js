...
// (U2f — the `[gate exception] tab reorder` block retired: the flat content-tab
// drag-reorder gesture + its `viewer_reorder_content_tab`-through-the-gate
// exception are gone. `[gate on]` below covers the drop behaviour.)
