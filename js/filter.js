...
// Filter mode now lives in the reducer (runtime.update: filter_enter /
// filter_key / filter_exit). The live editing draft is model.modal.filter
// {text, panel}; the COMMITTED per-panel filters are model.ui.filters. This
// module is the read-side FACADE — getFilter/matches are re-exported through
// the plugin API (PLUGINS.md) so plugins' getItems can filter their items.
