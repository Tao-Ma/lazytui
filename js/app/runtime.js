...
// The root-model store (the model object + init + getModel/setModel) was
// extracted to model/store.js in v0.6.5 §1 so panel/ and dispatch/ depend
// *down* on it instead of reaching up here. The reducer stays in this file
// (it reads panel/route). These three are re-exported below for back-compat
